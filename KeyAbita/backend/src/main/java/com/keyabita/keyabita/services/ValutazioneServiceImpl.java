...
public class ValutazioneServiceImpl implements IValutazioneService {
    ...
    @Override
    public List<Valutazione> getValutazioniByCity(String nomeCitta) {
        return valutazioneRepository.findByImmobileCittaNome(nomeCitta);
    }

    @Override
    public List<Valutazione> getValutazioniRecenti(int numero) {
        return valutazioneRepository.findTopByOrderByDataCreazioneDesc(numero);
    }
}